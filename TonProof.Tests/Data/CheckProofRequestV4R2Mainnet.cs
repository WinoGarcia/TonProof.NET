...
public class CheckProofRequestV4R2Mainnet : TheoryData<CheckProofRequest>
{
    public CheckProofRequestV4R2Mainnet()
    {
        this.Add(new CheckProofRequest
        {
            Address = "0:0522952c6d0846ad7f93dfb7987e5f77f02ee53290a26f9be85a50c689085932",
            Network = "-239",
            PublicKey = "e635249f6b3fbaf9742ae1d09d8f6f01b6082ff9256d719006329405019f3198",
            Proof = new Proof
            {
                Timestamp = 1721827476,
                Domain = new Domain
                {
                    LengthBytes = 20,
                    Value = "winogarcia.github.io"
                },
                Signature = "z05SXc3qseQ/c/Fwmp+D4+qF2QWRAbP7E8mcYwbxBTqsEcG/DQdMdUUJhYx0NQTpid38oxBDYnJ9vB0cZkd/Bw==",
